...
export const blockPreviewImageUrls: Record<string, string> = {
  ...
  eventListBlock: '/static/block-previews/event-list.svg',
  listBlock: '/static/block-previews/list.svg',
  classDescriptionsBlock: '/static/block-previews/class-descriptions.svg',
...
export const blockPreviewMedia = {
  ...
  eventListBlock: createBlockPreviewMedia(
    blockPreviewImageUrls.eventListBlock,
    'Event list block preview',
  ),
  listBlock: createBlockPreviewMedia(blockPreviewImageUrls.listBlock, 'List block preview'),
  classDescriptionsBlock: createBlockPreviewMedia(
    blockPreviewImageUrls.classDescriptionsBlock,
    'Class descriptions block preview',
  ),
