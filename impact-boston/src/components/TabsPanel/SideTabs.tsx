        ...
        <div className="relative col-span-full overflow-x-auto overflow-y-hidden flex scrollbar-hide lg:col-span-5 lg:flex-col">
          ...
          {tabs.map((tab, idx) => (
            <button
              ...
              className={`h3 cursor-pointer whitespace-nowrap px-4 py-2 border-b-4 lg:border-b-0 lg:border-l-4 transition-colors duration-150 lg:text-left ${
                tabs.length <= 3 ? "flex-1 lg:flex-none" : ""
              } ${ active === idx ? "border-transparent font-bold" : "border-gray-300 text-gray-500"}`}
