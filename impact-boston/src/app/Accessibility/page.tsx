...
const ACCESSIBILITY_PAGE_FALLBACK_BLOCKS: CmsPageBlock[] = [
  {
    ...
    imageAlt: "Accessibility Information",
  ...
  },
  {
    ...
    showToggle: false,
    noPaddingTop: true,
    listItems: accessibilityListItems,
  },
  {
    _key: "accessibility-policies",
    _type: "ctaSectionBlock",
    panels: [
      {
        _key: "accessibility-nondiscrimination-policy",
        bgColor: "#e86834",
        buttonText: "Read Document",
        description:
          "Our commitment to equal treatment and how to report concerns.",
        href: "/",
        icon: "download",
      ...
      {
        _key: "accessibility-language-access-policy",
        bgColor: "#311e41",
        buttonText: "Read Document",
        description:
          "How we support participants who need language assistance.",
        href: "/",
        icon: "download",
